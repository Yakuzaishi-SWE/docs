\section{Processi organizzativi}\label{section:processi_organizzativi}
  ...
  \subsection{Impiego delle infrastrutture interne} \label{subsection:infrastrutture_interne}
    ...
    \paragraph {Gestione dei rischi}
      Il \roleProjectManager\ ha il compito di individuare i rischi e renderli noti, tale attività verrà svolta nel \textit{Piano di Progetto}, questa procedura contiene i seguenti punti:
      \begin{figure}[htbp]
        \centering 
