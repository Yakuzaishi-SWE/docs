...
\subsection{Verifica} \label{subsection: Verifica}
    ...
    \begin{itemize}
        ...
        \item \textbf{Inspection}: Il verificatore esegue un controllo mirato ai soli punti del documento nei quali vi è una più ampia possibilità di errori. Il controllo mirato avviene grazie all'esperienza del verificatore e a una lista di controllo\glo.
    \end{itemize}
