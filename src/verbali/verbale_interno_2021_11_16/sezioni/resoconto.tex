...
più si sale di livello, più ci si allontana dallo "strato fisico".
	...
	rispettivamente alle esigenze del problema. Qui sotto sono riportati i pro e contro di ogni soluzione.
		...
		Avalanche\glo{} è un protocollo che integra diverse blockchain\glo{}, che permette la creazione di asset tokenizzati, l'esecuzione di smart contract e anche la creazione di blockchain\glo{} private. 
		...
		Solana è una blockchain\glo{} open source\glo{}, permissionless che garantisce un alto numero di transazioni al secondo. Queste caratteristiche sono ottenute principalmente dall'architettura a basso livello
		...
		\paragraph{Contro}
		\begin{itemize}
			\item Non è una blockchain\glo{} Ethereum\glo{} compatibile, quindi gli smart contract non possono essere scritti in Solidity\glo{}. Il linguaggio necessario assomiglia al C\glo{} e a RUST\glo{} e risulta essere più complesso per chi si trova alla prima esperienza con queste tecnologie;
		...
		è una piattaforma che ha i suoi punti di forza su high-performance, scalabilità e sicurezza negli smart contract. Nasce per risolvere le limitazioni delle precedenti piattaforme blockchain\glo{} (come molte altre sue coetanee).
		...
		\begin{itemize}
			...
			\item Fee molto basse;
			\item Blockchain\glo{} Ethereum\glo{} compatibile, quindi possibilità di usare Solidity\glo{} come linguaggio per gli smart contract;
