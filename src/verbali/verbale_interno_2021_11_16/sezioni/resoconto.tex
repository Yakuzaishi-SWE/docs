...
\subsection{Ethereum}
Ethereum è la blockchain\glo{} più famosa dopo quella di Bitcoin\glo{}, prende la struttura di base di quest'ultima e aggiunge delle
...
\begin{table}[H]
	...
	\begin{tabular}{c | p{10cm}}
		...
		\hline
		VI-2021-11-16-1 & È stata scelta come blockchain\glo{} di riferimento Fantom, la quale verrà presentata al proponente per essere approvata\\ \hline
	\end{tabular}
\end{table}
