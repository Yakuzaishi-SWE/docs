...
\end{figure}
    ...
    Qualora non si fosse connessi a MetaMask, ShopChain risulterà inutilizzabile nella gran parte delle pagine (praticamente tutte quelle in cui è necessaria l'interazione con lo stesso e, di conseguenza, le pagine figlie.), le quali saranno infatti oscurate da un overlay che richiede di effettuare la connessione:
    \begin{figure}[H]
        \centering
