...
\newglossaryentry{ERC20 Token}
{
  name={Token},
  description={Un token è An ERC20 token is a standard used for creating and issuing smart contracts on the Ethereum blockchain}
}
