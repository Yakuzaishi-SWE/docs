\section{Tecnologie coinvolte} \label{section:tecnologie_coinvolte}
...
\begin{table}[H]
	...
	\begin{tabular}{c | c | c}
        ...
        Solidity & 1.0 & \shortstack{Linguaggio usato per la creazione di smart contracts su varie blockchain,\\ in particolare tutte quelle basate su Ethereum} \\ \hline
        ...
        Truffle & 5.4.33 & \shortstack{Ambiente di test locale per smart contract} \\ \hline
