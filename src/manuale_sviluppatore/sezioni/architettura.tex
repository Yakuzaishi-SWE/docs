...
I primi cinque attributi di \textbf{OrderManager}, assieme alle funzioni \textit{isStableCoinPegged()}, \textit{getPriceStableCoin()}, \textit{stablecoinIsPegged}, servono alla conversione in stable coin\glo\ dei pagamenti in FTM.
