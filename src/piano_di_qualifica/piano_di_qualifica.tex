...
\begin{document}
	...
	\renewcommand{\documentSummary}{Questo documento raccoglie le strategie di qualifica e gli obiettivi di qualità perseguiti dal gruppo \groupName{} nello svoglimento del progetto \projectName{}}
	%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
