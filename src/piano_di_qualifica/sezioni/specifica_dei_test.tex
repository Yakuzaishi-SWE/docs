...
\begin{table}[H]
  ...
  \begin{tabular}{c|p{8cm}|c|c}
    ...
    TS1F16.1   & Verificare che l'utente possa visualizzare i dettagli dell'ordine pagato.                & R1F16.1   & S \\
    TS1F16.1.1 & Verificare che l'utente possa visualizzare l'id dell'ordine pagato.                      & R1F16.1.1 & S \\
    TS1F16.1.2 & Verificare che l'utente possa visualizzare l'indirizzo del venditore dell'ordine pagato. & R1F16.1.2 & S \\
    TS1F16.1.3 & Verificare che l'utente possa visualizzare l'ammontare dell'ordine pagato.               & R1F16.1.3 & S \\
    TS1F16.1.4 & Verificare che l'utente possa visualizzare lo stato dell'ordine pagato.                  & R1F16.1.4 & S \\
    TS1F16.1.5 & Verificare che l'utente possa visualizzare la data dell'ordine pagato.                   & R1F16.1.5 & S \\
  \end{tabular}
