...
Dopo aver effettuato l'incontro con il proponente per la risoluzione di alcuni dubbi il gruppo si è trovato a dover rivedere la struttura generale dell'applicativo poiché poco estendibile per usi futuri.
...
\subsection{Sprint 7 - Validazione e collaudo} \label{subsection:consuntivo_sprint7}
\subsubsection{Variazione della pianificazione} \label{subsubsection:variazione_pianificazione_sprint7}
...
\begin{table}[H]
  ...
  \begin{tabular}{c|c|c|c|c|c|c|c}
    ...
    \multicolumn{1}{c}{\color[HTML]{FFFFFF}\textbf{ Nominativo }}
                         ...
                         & \multicolumn{1}{c}{\color[HTML]{FFFFFF}\textbf{ Ore totali }}                                                                                                          \\
    \hline
    Bugno Francesco      & -                                                             & -               & -          & 1 (-1)          & - (-1)          & 2               & 3 (-2)            \\
    Busacca Luca         & -                                                             & -               & -          & 1 (-1)          & 2 (-1)          & -               & 3 (-2)            \\
    Carturan Luca        & -                                                             & -               & -          & 1               & 1 (-1)          & 1 (-1)          & 3 (-2)            \\
    Filosofo Michele     & -                                                             & -               & -          & 2               & 1 (-1)          & 1               & 4 (-1)            \\
    Furlan Dario         & -                                                             & -               & -          & 1 (-1)          & 1 (-1)          & 1               & 3 (-2)            \\
    Mattarello Francesco & 2                                                             & -               & -          & -               & - (-1)          & 1 (-1)          & 3 (-2)            \\
    Midena Matteo        & -                                                             & 1 (-1)          & -          & - (-1)          & 2               & -               & 3 (-2)            \\
    \textbf{Ore totali}  & \textbf{2}                                                    & \textbf{1 (-1)} & \textbf{-} & \textbf{6 (-4)} & \textbf{7 (-6)} & \textbf{6 (-2)} & \textbf{22 (-13)}
  \end{tabular}
  \caption{Variazione delle ore nel settimo Sprint}
\end{table}

\subsubsection{Variazione dei costi} \label{subsubsection:variazione_costi_sprint7}
...
\begin{table}[H]
  ...
  \begin{tabular}{c|c|c}
    ...
    \hline
    Responsabile                                           & 2            & 60,00            \\
    Amministratore                                         & 1 (-1)       & 20,00 (-20,00)   \\
    Analista                                               & -            & -                \\
    Progettista                                            & 6 (-4)       & 150,00 (-100,00) \\
    Programmatore                                          & 7 (-6)       & 105,00 (-90,00)  \\
    Verificatore                                           & 6 (-2)       & 90,00 (-30,00)   \\
    \textbf{Totale Preventivo}                             & \textbf{35}  & \textbf{665,00}  \\
    \textbf{Totale Consuntivo}                             & \textbf{22}  & \textbf{425,00}  \\
    \textbf{Bilancio}                                      & \textbf{-13} & \textbf{-240,00} \\
  \end{tabular}
  \caption{Sprint 7 - Consuntivo di periodo}
\end{table}

\subsubsection{Ragione degli scostamenti} \label{subsubsection:ragione_scostamenti_sprint7}
Questo risparmio è dovuto principalmente al poco tempo che il gruppo è riuscito a dedicare durante questo Sprint\glo{} a causa di impegni lavorativi e all'inizio della sessione d'esame.

\subsubsection{Considerazioni rispetto al preventivo} \label{subsubsection:considerazioni_finali_sprint7}
Il bilancio risulta essere positivo di 240,00€ rispetto al preventivo per questo Sprint\glo{}.
\\Tutte le attività preventivate sono state comunque completate, segno di una buona maturità da parte del gruppo nello svolgerle con maggiore sicurezza e senza perdite di tempo.

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\subsection{Sprint 8 - Validazione e collaudo} \label{subsection:consuntivo_sprint8}
\subsubsection{Variazione della pianificazione} \label{subsubsection:variazione_pianificazione_sprint8}
...
\begin{table}[H]
  ...
  \begin{tabular}{c|c|c|c|c|c|c|c}
    ...
    \multicolumn{1}{c}{\color[HTML]{FFFFFF}\textbf{ Nominativo }}
                         ...
                         & \multicolumn{1}{c}{\color[HTML]{FFFFFF}\textbf{ Ore totali }}                                                                                                          \\
    \hline
    Bugno Francesco      & -                                                             & -               & -          & -               & 2 (-1)          & 1               & 3 (-1)            \\
    Busacca Luca         & -                                                             & -               & -          & - (-1)          & 1 (-1)          & 1               & 2 (-2)            \\
    Carturan Luca        & -                                                             & 1 (-1)          & -          & -               & - (-2)          & 1               & 2 (-3)            \\
    Filosofo Michele     & -                                                             & -               & -          & - (-1)          & 2               & 1               & 3 (-1)            \\
    Furlan Dario         & 2                                                             & -               & -          & -               & 1 (-1)          & -               & 3 (-1)            \\
    Mattarello Francesco & -                                                             & -               & -          & -               & 1 (-1)          & 2               & 3 (-1)            \\
    Midena Matteo        & -                                                             & -               & -          & - (-1)          & 1               & 1 (-1)          & 2 (-2)            \\
    \textbf{Ore totali}  & \textbf{2}                                                    & \textbf{1 (-1)} & \textbf{-} & \textbf{- (-3)} & \textbf{8 (-6)} & \textbf{7 (-1)} & \textbf{18 (-11)}
  \end{tabular}
  \caption{Variazione delle ore nell'ottavo Sprint}
\end{table}

\subsubsection{Variazione dei costi} \label{subsubsection:variazione_costi_sprint8}
...
\begin{table}[H]
  ...
  \begin{tabular}{c|c|c}
    ...
    Analista                                               & -            & -                \\
    Progettista                                            & - (-3)       & - (-75,00)       \\
    Programmatore                                          & 8 (-6)       & 120,00 (-90,00)  \\
    Verificatore                                           & 7 (-1)       & 105,00 (-15,00)  \\
    \textbf{Totale Preventivo}                             & \textbf{29}  & \textbf{505,00}  \\
    \textbf{Totale Consuntivo}                             & \textbf{18}  & \textbf{305,00}  \\
    \textbf{Bilancio}                                      & \textbf{-11} & \textbf{-200,00} \\
  \end{tabular}
  \caption{Sprint 8 - Consuntivo di periodo}
\end{table}

\subsubsection{Ragione degli scostamenti} \label{subsubsection:ragione_scostamenti_sprint8}
Il gruppo ha deciso di ridimensionare le attività rimanenti andando a decidere quali requisiti opzionali mancanti implementare e quali invece escludere.
Questo risparmio è dovuto principalmente al poco tempo che il gruppo è riuscito a dedicare durante questo Sprint\glo{} a causa di impegni lavorativi e alla sessione d'esame.

\subsubsection{Considerazioni rispetto al preventivo} \label{subsubsection:considerazioni_finali_sprint8}
Il bilancio risulta essere positivo di 200,00€ rispetto al preventivo per questo Sprint\glo{}.
\\Avendo ridimensionato le attività preventivate ci è stato richiesto meno tempo del previsto per il loro completamento.

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\subsection{Sprint 9 - Validazione e collaudo} \label{subsection:consuntivo_sprint9}
\subsubsection{Variazione della pianificazione} \label{subsubsection:variazione_pianificazione_sprint9}
...
\begin{table}[H]
  ...
  \begin{tabular}{c|c|c|c|c|c|c|c}
    ...
    Busacca Luca         & -                                                             & -          & -          & -          & 1 (-1)          & 1 (+1)          & 3                \\
    Carturan Luca        & 1 (-1)                                                        & -          & -          & -          & -               & 1               & 2 (-1)           \\
    Filosofo Michele     & -                                                             & 1          & -          & -          & 1 (-1)          & 1               & 3                \\
    Furlan Dario         & -                                                             & -          & -          & -          & 1 (+1)          & - (-2)          & 2 (-1)           \\
    Mattarello Francesco & -                                                             & -          & -          & -          & - (-2)          & 2               & 2 (-2)           \\
    Midena Matteo        & -                                                             & -          & -          & -          & 1               & 1 (-1)          & 2 (-1)           \\
    \textbf{Ore totali}  & \textbf{1 (-1)}                                               & \textbf{1} & \textbf{-} & \textbf{-} & \textbf{6 (-3)} & \textbf{9 (-2)} & \textbf{17 (-6)}
  \end{tabular}
  \caption{Variazione delle ore nel nono Sprint}
\end{table}

\subsubsection{Variazione dei costi} \label{subsubsection:variazione_costi_sprint9}
...
\begin{table}[H]
  ...
  \begin{tabular}{c|c|c}
    ...
    \multicolumn{1}{c}{\color[HTML]{FFFFFF}\textbf{Costo (€)}}                              \\
    \hline
    Responsabile                                           & 1 (-1)      & 30,00 (-30,00)   \\
    Amministratore                                         & 1           & 20,00            \\
    Analista                                               & -           & -                \\
    Progettista                                            & -           & -                \\
    Programmatore                                          & 6 (-3)      & 90,00 (-45,00)   \\
    Verificatore                                           & 9 (-2)      & 135,00 (-30,00)  \\
    \textbf{Totale Preventivo}                             & \textbf{23} & \textbf{380,00}  \\
    \textbf{Totale Consuntivo}                             & \textbf{17} & \textbf{275,00}  \\
    \textbf{Bilancio}                                      & \textbf{-6} & \textbf{-105,00} \\
  \end{tabular}
  \caption{Sprint 9 - Consuntivo di periodo}
\end{table}

\subsubsection{Ragione degli scostamenti} \label{subsubsection:ragione_scostamenti_sprint9}
Il gruppo ha deciso di ridimensionare ulteriormente le attività rimanenti a seguito della revisione con il committente, andando ad ultimare il progetto a causa della mancanza di ulteriori ore lavorative.
Questo risparmio è dovuto principalmente al poco tempo che il gruppo è riuscito a dedicare durante questo Sprint\glo{} a causa di impegni lavorativi e alla sessione d'esame.

\subsubsection{Considerazioni rispetto al preventivo} \label{subsubsection:considerazioni_finali_sprint9}
Il bilancio risulta essere positivo di 105,00€ rispetto al preventivo per questo Sprint\glo{}.
\\Avendo ridimensionato le attività preventivate ci è stato richiesto meno tempo del previsto per il loro completamento.

\pagebreak
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\subsection{Preventivo vs Consuntivo} \label{subsection:preventivo_vs_consuntivo}
...
\begin{table}[H]
  ...
  \begin{tabular}{c|c|c}
    ...
    Sprint 7 - Validazione e collaudo     & 665,00                                                      & 425,00            \\
    Sprint 8 - Validazione e collaudo     & 505,00                                                      & 305,00            \\
    Sprint 9 - Validazione e collaudo     & 380,00                                                      & 275,00            \\
    \textbf{Totale}                       & \textbf{15875,00}                                           & \textbf{14900,00} \\
  \end{tabular}
...
\pagebreak
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Consuntivo totale di progetto} \label{subsection:consuntivo_totale}
Il totale delle ore rendicontate per il progetto diventa il seguente:
...
\begin{table}[H]
  ...
  \begin{tabular}{c|c|c|c|c|c|c|c}
    ...
    \multicolumn{1}{c}{\color[HTML]{FFFFFF}\textbf{ Nominativo }}
                        ...
                        & \multicolumn{1}{c}{\color[HTML]{FFFFFF}\textbf{ Ore totali }}                                                                                          \\
    \hline
    Bugno               & 13                                                            & 8           & 14           & 22           & 21           & 27           & 105          \\
    Busacca             & 6                                                             & 17          & 11           & 20           & 25           & 26           & 105          \\
    Carturan            & 12                                                            & 6           & 10           & 27           & 25           & 25           & 105          \\
    Filosofo            & 6                                                             & 10          & 17           & 26           & 21           & 25           & 105          \\
    Furlan              & 5                                                             & 10          & 18           & 26           & 23           & 23           & 105          \\
    Mattarello          & 6                                                             & 17          & 12           & 24           & 22           & 24           & 105          \\
    Midena              & 6                                                             & 5           & 22           & 21           & 30           & 21           & 105          \\
    \textbf{Ore totali} & \textbf{54}                                                   & \textbf{73} & \textbf{104} & \textbf{166} & \textbf{167} & \textbf{171} & \textbf{735}
  \end{tabular}
  \caption{Riepilogo della distribuzione oraria totale rendicontata - Consuntivo finale}
\end{table}

\begin{figure}[H]
  \centering
  \includegraphics[scale=1.0]{immagini/ore_lavoro_totale.png}
  \caption{Istogramma della distribuzione oraria totale rendicontata - Consuntivo finale}
\end{figure}
...
\begin{table}[H]
  ...
  \begin{tabular}{c|c|c}
    ...
    Analista        & 104                                                        & 2600,00           \\
    Progettista     & 166                                                        & 4150,00           \\
    Programmatore   & 167                                                        & 2505,00           \\
    Verificatore    & 171                                                        & 2565,00           \\
    \textbf{Totale} & \textbf{735}                                               & \textbf{14900,00} \\
  \end{tabular}
  \caption{Prospetto delle ore e dei costi delle ore rendicontate - Consuntivo finale}
\end{table}

\begin{figure}[H]
  \centering
  \includegraphics[scale=1.0]{immagini/ore_ruolo_totale.png}
  \caption{Areogramma delle ore per ruolo rendicontate sul totale - Consuntivo finale}
\end{figure}
