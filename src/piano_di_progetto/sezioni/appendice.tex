...
\begin{table}[H]
  ...
  \begin{tabular}{c|p{5cm}|p{5cm}|p{5cm}}
    ...
    \hline
    \textbf{RR2} & In accordo con il proponente è stato deciso di modificare un requisito a causa del poco tempo rimasto a disposizione del gruppo.   & È stato deciso di rendere opzionale un requisito precedentemente dichiarato come desiderabile.                                                & Nel caso in cui avanzasse del tempo si potrebbe implementare il requisito opzionale per la prossima revisione.                                                                                      \\
    \hline
  \end{tabular}
\end{table}
\begin{center}
