...
\begin{itemize}
  ...
  Le norme sono emanate dall'\roleAdministrator e il rispetto di quest'ultime dovrà essere certicato dai \roleVerifier. Vengono redatte le \docNameNdP;
  ...
  \item \textbf{Analisi dei requisiti:} tramite il capitolato d'appalto e gli incontri con il proponente, l'\roleAnalyst identifica i requisiti del sistema e redige una prima versione dell'\docNameAdR.
  I requisiti evolveranno nel periodo successivo in base ai feedback ricevuti dal proponente;
  \item \textbf{Piano di qualifica:} l'\roleAdministrator redige i piani e le procedure di gestione per la qualità, mentre il \roleVerifier illustra l'esito e la completezza delle verifiche. Viene redatto il \docNamePdQ;
  \item \textbf{Glossario:} viene creato il \docNameGlo. Questo documento viene aggiornato in modo continuativo dai \roleVerifier dei documenti aggiungendo termini che necessitano di spiegazione;
\end{itemize}
In questo periodo i ruoli coinvolti sono: \roleProjectManager, \roleAdministrator, \roleAnalyst e \roleVerifier.
...
\end{itemize}
In questo periodo i ruoli maggiormente coinvolti sono: \roleAdministrator, \roleAnalyst, \roleDesigner e \roleVerifier.
\bigskip
\begin{figure}[H]
  \centering
...
\begin{itemize}
  ...
  \item \textbf{Modifiche incrementali ai documenti:} in questo periodo vengono apportate delle modifiche incrementali sui documenti precedentemente redatti.
\end{itemize}
In questo periodo i ruoli maggiormente coinvolti sono: \roleDesigner, \roleProgrammer e \roleVerifier.
\bigskip
\begin{figure}[H]
  \centering
