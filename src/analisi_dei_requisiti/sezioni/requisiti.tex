...
\begin{table}[H]
    ...
    \begin{tabular}{c | c | p{6cm} | c}
        ...
        R1F16                                                             & Obbligatorio & L'utente deve poter visualizzare un pagina con i dettagli dell'ordine pagato.                                                & UC10 \\
        R1F17                                                             & Obbligatorio & L'utente deve poter visualizzare il codice di sblocco.                                                                       & UC6.2 \\
