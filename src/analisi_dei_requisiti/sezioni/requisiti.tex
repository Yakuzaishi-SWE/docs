...
\begin{table}[H]
    ...
    \begin{tabular}{c | c | p{6cm} | c}
        ...
        R2F2.2.4 & Desiderabile & Si deve poter chiudere la MoneyBox restituendo i soldi. & UC2.2.5 \\
...
\begin{table}[H]
    ...
    \begin{tabular}{c | c | p{6cm} | c}
        ...
        R1F6 & Obbligatorio & Il proprietario dell'ordine  deve poter richiedere il rimborso della transazione  & Capitolato \\
