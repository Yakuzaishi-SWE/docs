...
\begin{itemize}
    ...
    \item Ogni acquirente che dispone di un invito di partecipazione ad una MoneyBox è un partecipante MoneyBox;
    \item Infine ogni proprietario MoneyBox è anche un partecipante MoneyBox.
\end{itemize}
