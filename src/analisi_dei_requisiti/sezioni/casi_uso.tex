...
\begin{itemize}
    ...
    \item Scenario principale: l'utente seleziona la tipologia di pagamento;
    \item Estensioni:
    \begin{enumerate}
    \item Nel caso in cui la transazione interessata sia presente in blockchain\glo{}:
        \begin{itemize}
    ...
    \begin{itemize}
        ...
        \item Selezionato Pagamento MoneyBox [UC2.2.2].
    \end{itemize}
\end{itemize}
...
\begin{itemize}
    ...
    \item Precondizioni: è stata selezionata una tipologia di pagamento per la transazione interessata [UC2.2], 
