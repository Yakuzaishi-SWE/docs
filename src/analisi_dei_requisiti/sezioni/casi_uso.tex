...
\subsection{UC8 - Annullamento Ordine}\label{subsection: UC8}
...
\subsection{UC9 - Richiesta Rimborso}\label{subsection: UC9}
...
\begin{itemize}
    \item Attore primario: utente proprietario dell'ordine, venditore;
    \item Attore secondario: Metamask\glo{};
