...
\subsection{UC2.1 - Visualizzazione Riepilogo Ordine}\label{sssec: UC2.1}
...
\subsubsection{UC2.2.1 - Selezionato Pagamento Unico}\label{sssec: UC2.2.1}
...
\subsubsection{UC2.2.2 -  Selezionato Pagamento MoneyBox}
...
\subsubsection{UC2.3.1 - Pagamento Unico}
...
\subsubsection{UC2.3.2 - Pagamento MoneyBox}
...
\subsubsection{UC2.3.3 - Generazione Codice di Sblocco}
...
\subsubsection{UC2.3.4 - Visualizzazione errore transazione annullata}
...
\subsubsection{UC3 - Gestione MoneyBox}
...
\subsection{UC5.1 - Visualizzazione Indirizzo Wallet Testuale}
...
\subsection{UC5.2 - Visualizzazione Indirizzo Wallet Emoji}
...
\subsection{UC5.3 - Visualizzazione Avviso Connessione Metamask}
...
\subsubsection{UC7.2.3 - Visualizza Transazioni Pagate e Sbloccate}
