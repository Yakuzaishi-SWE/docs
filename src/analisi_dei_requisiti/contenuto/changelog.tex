...
\begin{center}
	...
	\begin{longtable}[c]{c | c | c | c | p{5cm}}
		...
		2.0.5 & 2022/05/12 & \Longunderstack{Matteo Midena \\ Luca Busacca} & \Longunderstack{Analista \\ Verificatore} & Correzione UC10 e verifica \\
		2.0.4 & 2022/05/11 & \Longunderstack{Matteo Midena \\ Francesco Mattarello} & \Longunderstack{Analista \\ Verificatore} & Riadattamento specifica UC3 gestione moneybox e verifica \\
		2.0.3 & 2022/05/11 & \Longunderstack{Matteo Midena \\ Luca Busacca} & \Longunderstack{Analista \\ Verificatore} & Riadattamento specifica UC2 per pagamento moneybox e verifica \\
		2.0.2 & 2022/05/11 & \Longunderstack{Matteo Midena \\ Francesco Mattarello} & \Longunderstack{Analista \\ Verificatore} & Declassamento requisito R2F9 a opzionale \\
		2.0.1 & 2022/05/02 & \Longunderstack{Luca Carturan,\\Matteo Midena} & \Longunderstack{Analista,\\Verificatore} & Modifiche ai requisiti funzionali e verifica\\
