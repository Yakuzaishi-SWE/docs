...
\begin{itemize}
    ...
    \item \textbf{Truffle Suite [Deprecato]}:
    ...
    \item \textbf{Chai}: È una libreria di testing per Node.js e browser.
          \begin{center}\url{https://www.chaijs.com/}\end{center}
    \item \textbf{Jest}: È un framework di test JavaScript\glo{} per i programmi Typescript.js;
          \begin{center}\url{https://jestjs.io/}\end{center}
    \item \textbf{Cypress}: È un framework di test e2e.
          \begin{center}\url{https://www.cypress.io/}\end{center}
    \item \textbf{Hardhat}: È un framework di test di compilazione e di esecuzione di smart contract\glo{} per Ethereum\glo{}.
          \begin{center}\url{https://hardhat.org/}\end{center}
    \end{itemize}
\paragraph{Strumenti per la documentazione}
\paragraph{Strumenti di supporto alla codifica}
\begin{itemize}
