...
\subsection{Sviluppo} \label{subsection:Sviluppo}
    ...
    \end{itemize}
        ...
        Di seguito sono riportati gli strumenti utilizzati dal team di sviluppo durante la fase di codifica:
        \begin{itemize}
            \item \textbf{da inserire strumenti utilizzati in fase di codifica}
        \end{itemize}
